    ...
    <div class="max-w-5xl mx-auto space-y-24">
      ...
      >
        ...
        <div class="flex-1">
          ...
          Menguasai berbagai bahasa pemrograman seperti html, python, dart, php dan tools relevan. Proaktif dalam mempelajari hal baru, mampu bekerja secara mandiri maupun dalam tim, mampu untuk memanajemen tim, serta berdedikasi untuk mencapai hasil yang optimal.        </div>
      </div>
...
const skills = [
  ...
  { name: 'C++', logo: '/logos/c.svg', level: 'Beginner' },
