...
const uiuxProjects = ref([
  ...
  { title: 'Design UI/UX Home gardening Mobile App', description: 'Merancang design UI aplikasi mobile Home Gardening berbasis IoT secara real time.', shortDescription: 'Perancangan design UI aplikasi mobile Home Gardening yang berbasis IoT real-time.', tags: ['Figma', 'dart', 'Php'], image: '/projects/homgar.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/proto/AnfJauFzqWtu2zQY7EYbEC/Home-Garden?page-id=101%3A1295&node-id=619-3405' },
  { title: 'Design UI/UX Healthmate Mobile App', description: 'Merancang design UI aplikasi mobile Healtmate untuk konsultasi dengan dokter.', shortDescription: 'Perancangan design UI aplikasi mobile Healthmate untuk layanan konsultasi dengan dokter.', tags: ['Figma', 'dart', 'Php'], image: '/projects/health.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/design/ahQTmHMMWA0VBWljx52xbt/Untitled?node-id=0-1' },
  { title: 'Design UI/UX Funk Kitchen Mobile App', description: 'Merancang design UI aplikasi mobile Funk Kitchen untuk order makanan dine in & pickup.', shortDescription: 'Perancangan design UI aplikasi mobile Funk Kitchen untuk order makanan (dine in & pickup).', tags: ['Figma', 'dart', 'Php'], image: '/projects/funk.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/design/CRNizE7dmZNmg13VmSbc2M/FUNK-KITCHEN?node-id=0-1' },
])
