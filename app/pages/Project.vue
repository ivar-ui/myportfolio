...
const projects = [
  ...
  { title: 'Design UI/UX Healthmate Mobile App', description: 'Merancang dan mengembangkan design UI aplikasi mobile home gardening yang interaktif dan berbasis Internet of Things secara real time.', tags: ['Figma', 'dart', 'Php'], image: '/projects/health.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/design/ahQTmHMMWA0VBWljx52xbt/Untitled?node-id=0-1&t=ODcEJn2qAKjIxawY-1' },
  { title: 'Design UI/UX Funk Kitchen Mobile App', description: 'Merancang dan mengembangkan design UI aplikasi mobile home gardening yang interaktif dan berbasis Internet of Things secara real time.', tags: ['Figma', 'dart', 'Php'], image: '/projects/funk.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/proto/CRNizE7dmZNmg13VmSbc2M/FUNK-KITCHEN?node-id=0-1&t=iYLSJcgvkWZbL2AC-1' },
  { title: 'Design UI/UX digihub Website', description: 'Merancang dan mengembangkan design UI aplikasi mobile home gardening yang interaktif dan berbasis Internet of Things secara real time.', tags: ['Figma', 'dart', 'Php'], image: '/projects/digihub.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/proto/2ZEoQZMWLKWnxJ7yOc34i4/Digihub-Website?node-id=0-1&t=dJpEJgtNjIUpG5GM-1' },
]
