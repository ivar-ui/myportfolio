...
const projects = [
  ...
  { title: 'Design UI/UX digihub Website', description: 'Merancang dan mengembangkan design UI website bussiness plan bertajuk DigiHub, website yang menawarkan jasa jual beli design serta joki dengan berbagai fitur menarik lainnya seperti chat, order, list, dan upload.', tags: ['Figma', 'Javascript', 'Php'], image: '/projects/digihub.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/proto/2ZEoQZMWLKWnxJ7yOc34i4/Digihub-Website?node-id=0-1&t=dJpEJgtNjIUpG5GM-1' },
  { title: 'Design UI/UX Reshine Mobile App', description: 'Merancang dan mengembangkan design UI aplikasi mobile jual beli template design dan jasa joki multimedia.', tags: ['Figma', 'Adobe'], image: '/projects/uiux.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/design/HqhsgmEg9OHXiHjzlvk1rp/Userflow-IMK?node-id=0-1' },
  { title: 'Design UI/UX Home gardening Mobile App', description: 'Merancang dan mengembangkan design UI aplikasi mobile Home Gardening yang interaktif dan berbasis Internet of Things secara real time.', tags: ['Figma', 'dart', 'Php'], image: '/projects/homgar.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/proto/AnfJauFzqWtu2zQY7EYbEC/Home-Garden?page-id=101%3A1295&node-id=619-3405&starting-point-node-id=582%3A1998&t=cmWYsYcfvLqqE7kN-1' },
  { title: 'Design UI/UX Healthmate Mobile App', description: 'Merancang dan mengembangkan design UI aplikasi mobile bertajuk Healtmate yang interaktif, memungkinkan pasien untuk kontrol dan konsultasi kepada dokter atau tenaga kesehatan via mobile apps.', tags: ['Figma', 'dart', 'Php'], image: '/projects/health.png', github: 'https://github.com/username/fundraising-app', demo: 'https://www.figma.com/design/ahQTmHMMWA0VBWljx52xbt/Untitled?node-id=0-1&t=ODcEJn2qAKjIxawY-1' },
  { title: 'Design UI/UX Funk Kitchen Mobile App', description: 'Merancang dan mengembangkan design UI aplikasi mobile Funk Kitchen, aplikasi mobile yang menawarkan fitur order makanan melalui mobile apps, user juga dapat melakukan order secara dine in ataupun pickup.', tags: ['Figma', 'dart', 'Php'], image: '/projects/funk.png', github: 'https://www.figma.com/design/CRNizE7dmZNmg13VmSbc2M/FUNK-KITCHEN?node-id=0-1&t=0RxY8a9vLtJEQnpZ-1' },
  ]
